...
class DynamicDataHandler:
    ...
    def insert_data(self, table_name, data_list):
        ...
        for data in data_list:
            ...
            # Exclui chaves que não devem ser consideradas na verificação de duplicidade
            check_data = {key: value for key, value in data.items() if key not in ['id', 'insert_datetime']}
